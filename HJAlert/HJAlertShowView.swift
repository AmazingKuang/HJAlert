...
class HJAlertShowView: UIView {

    private var alertConfig : HJShowAlertConfig
    ...
    private lazy var leftBtn : UIButton = {
        ...
        leftBtn.titleLabel?.font = alertConfig.buttonLeftFont
        leftBtn.setTitleColor(alertConfig.leftColor, for: .normal)
        leftBtn.backgroundColor = alertConfig.leftBgColor
    ...
    private lazy var rightBtn : UIButton = {
        let rightBtn = UIButton(type: .system)
         rightBtn.titleLabel?.font = alertConfig.buttonRightFont
         rightBtn.setTitleColor(alertConfig.rightColor, for: .normal)
        rightBtn.backgroundColor = alertConfig.rightBgColor
    ...
    init(title: String? = nil,
        ...
        if (alertConfig.rightButtonPadding != 0) {
            rightBtn.layer.masksToBounds = true
            rightBtn.layer.cornerRadius = 3
        }
        rightBtn.snp.makeConstraints { (make) in
            make.top.equalTo(lineView.snp.bottom).offset(alertConfig.rightButtonPadding)
            make.left.equalTo(leftBtnTitle != nil || leftBtnAttributedTitle != nil ? containerView.snp.centerX : containerView.snp.left).offset(alertConfig.rightButtonPadding)
            make.right.equalToSuperview().offset(-alertConfig.rightButtonPadding)
            make.height.equalTo(alertConfig.buttonHeight)
            make.bottom.equalToSuperview().offset(-alertConfig.rightButtonPadding)
        }
